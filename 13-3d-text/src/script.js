...
fontLoader.load("/fonts/helvetiker_regular.typeface.json",
    (font) => {
        const textGeometry = new THREE.TextGeometry('AIKIDO', {
            font: font,
            size: 0.5,
            height: 0.2,
            curveSegments: 32,
        ...
        const toruses = new THREE.Group()
        const torusGeometry = new THREE.TorusGeometry(0.2, 0.1, 20, 45)
